...
- [Which gritty, rigged 3D characters and dungeon kit could replace KayKit?](issues/12-gritty-3d-assets.md): new-generation Quaternius (CC0, one shared skeleton, clips play without retargeting) covers the Warrior, 3 enemy types and a stone-cellar Area for $0–55; Synty Dark Fantasy is the grimmer, paid, no-clips runner-up; models need cutting down (tris, textures, meshes) for the phone.
