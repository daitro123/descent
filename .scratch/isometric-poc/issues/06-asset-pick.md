# Which asset pack(s) does the PoC use?
...
From the shortlist for the chosen rendering approach, pick the assets for the Warrior, the 3 enemy types and the Area. Confirm the licence, record any purchase (who buys, where the files live), and note animation gaps we'd have to work around.
